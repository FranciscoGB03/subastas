...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-xs-3 col-md-3 izquierda">
          ...
          <img src="Recursos/imagenes/desarmadores.jpg" height="400" width="400"/>
              </div>
            </div>
        </div>
        <!--Columna Central-->
        <div class="col-xs-6 col-md-6 central" id="tabla">
              ...
              <center><h4 class="titulo">Paquete de Desarmadores</h4></center>
              <br>
                   <center><table  style="margin-top:40px; ">
   <tbody>
    <tr>
        <td>8 desarmadores de diversos tamaños bonitos y baratos<br>Marca: Pretul
            <br> Modelo: 7890FGT <br>
        Precio:$80.00</td>   
