    ...
    <div class="row">
        ...
        <div class="col-xs-3 col-md-3 izquierda">
        	<div class="panel panel-default">
              ...
              <img src="Recursos/imagenes/logo.png" width="150" height="150"/>
              </div>
            </div>
        </div>
        <!--Columna Central-->
        <div class="col-xs-6 col-md-6 central" id="tabla">
              <center><h1 class="titulo">Subastas TecNM Toluca</h1></center>
              <br>
        <center><img src="Recursos/imagenes/subastas.jpg" width="500" height="180"/></center>
        <br>
        <p>Somos un sitio web seguro, que permite a sus usuarios adquirir 
            bienes através de la participación en subastas por medio de internet
        asegurando que los productos mostrados cuantan con 100% de calidad y damos certeza
        de que los productos llegan al domicilio indicado en un máximo de 15 días.</p>
